...
if [[ -z "$1" ]]; then 
  echo "Parameter 1, PLATFORMS is empty, using default set" ; platforms=( alpine debian8 debian9 debian10 centos8 centos7 centos6 amazon1 amazon2 archlinux ubuntu1404 ubuntu1604 ubuntu1804 ubuntu2004 ); 
else
